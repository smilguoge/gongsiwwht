  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="名称" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.label }} ({{ scope.row.route }})</span>
        </template>
      </el-table-column>
...
<script>
import { getMenutree, postMenu, getMenuList, getMenuPlist, deleteMenu } from '@/api/menu'
  ...
  methods: {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          postMenu(this.temp).then(response => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          postMenu(tempData).then(response => {
